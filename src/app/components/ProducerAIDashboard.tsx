...
import { CreateLotWorkflow } from "./producer-dashboard/CreateLotWorkflow";
...
export function ProducerAIDashboard({ producerName = "Producer", onBack }: ProducerAIDashboardProps) {
  // Grok AI Alerts
  ...
  const [activeSection, setActiveSection] = useState<
    "dashboard" | "post-requirement" | "create-lot" | "crop-lifecycle" | "activities" | "crop-health" | "inventory" | "profile" | "settings" | "commodities" | "costs"
  >("dashboard");
