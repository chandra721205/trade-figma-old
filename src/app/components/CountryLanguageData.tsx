...
export const languages = [
  ...
  { name: "Chinese (Mandarin)", code: "zh", icon: "🇨🇳" },
  ...
  // Indian Languages (22 Official Languages + Important Regional)
  { name: "Hindi", code: "hi", icon: "🇮🇳" },
  { name: "Bengali (Bangla)", code: "bn", icon: "🇮🇳" },
  { name: "Telugu", code: "te", icon: "🇮🇳" },
  { name: "Marathi", code: "mr", icon: "🇮🇳" },
  { name: "Tamil", code: "ta", icon: "🇮🇳" },
  { name: "Urdu", code: "ur", icon: "🇮🇳" },
  { name: "Gujarati", code: "gu", icon: "🇮🇳" },
  { name: "Kannada", code: "kn", icon: "🇮🇳" },
  { name: "Odia (Oriya)", code: "or", icon: "🇮🇳" },
  { name: "Malayalam", code: "ml", icon: "🇮🇳" },
  { name: "Punjabi", code: "pa", icon: "🇮🇳" },
  { name: "Assamese", code: "as", icon: "🇮🇳" },
  { name: "Maithili", code: "mai", icon: "🇮🇳" },
  { name: "Sanskrit", code: "sa", icon: "🇮🇳" },
  { name: "Konkani", code: "kok", icon: "🇮🇳" },
  { name: "Manipuri (Meitei)", code: "mni", icon: "🇮🇳" },
  { name: "Nepali", code: "ne", icon: "🇮🇳" },
  { name: "Bodo", code: "brx", icon: "🇮🇳" },
  { name: "Dogri", code: "doi", icon: "🇮🇳" },
  { name: "Kashmiri", code: "ks", icon: "🇮🇳" },
  { name: "Santali", code: "sat", icon: "🇮🇳" },
  { name: "Sindhi", code: "sd", icon: "🇮🇳" },
  { name: "Rajasthani", code: "raj", icon: "🇮🇳" },
  { name: "Bhojpuri", code: "bho", icon: "🇮🇳" },
  { name: "Haryanvi", code: "bgc", icon: "🇮🇳" },
  { name: "Chhattisgarhi", code: "hne", icon: "🇮🇳" },
  { name: "Magahi", code: "mag", icon: "🇮🇳" },
  { name: "Awadhi", code: "awa", icon: "🇮🇳" },
  { name: "Marwari", code: "mwr", icon: "🇮🇳" },
  { name: "Tulu", code: "tcy", icon: "🇮🇳" },
  { name: "Khasi", code: "kha", icon: "🇮🇳" },
  { name: "Garo", code: "grt", icon: "🇮🇳" },
  { name: "Mizo", code: "lus", icon: "🇮🇳" },
  { name: "Nagamese", code: "nag", icon: "🇮🇳" },
  
  // Other Asian Languages
  { name: "Turkish", code: "tr", icon: "🇹🇷" },
  { name: "Indonesian", code: "id", icon: "🇮🇩" },
  { name: "Malay", code: "ms", icon: "🇲🇾" },
  { name: "Tagalog (Filipino)", code: "tl", icon: "🇵🇭" },
  { name: "Vietnamese", code: "vi", icon: "🇻🇳" },
  { name: "Thai", code: "th", icon: "🇹🇭" },
  { name: "Persian (Farsi)", code: "fa", icon: "🇮🇷" },
  { name: "Burmese", code: "my", icon: "🇲🇲" },
  { name: "Khmer", code: "km", icon: "🇰🇭" },
  { name: "Lao", code: "lo", icon: "🇱🇦" },
  { name: "Sinhala", code: "si", icon: "🇱🇰" },
  { name: "Mongolian", code: "mn", icon: "🇲🇳" },
  ...
  { name: "Serbian", code: "sr", icon: "🇷🇸" },
  { name: "Ukrainian", code: "uk", icon: "🇺🇦" },
  { name: "Lithuanian", code: "lt", icon: "🇱🇹" },
  { name: "Latvian", code: "lv", icon: "🇱🇻" },
  { name: "Estonian", code: "et", icon: "🇪🇪" },
  { name: "Slovenian", code: "sl", icon: "🇸🇮" },
  { name: "Albanian", code: "sq", icon: "🇦🇱" },
  { name: "Macedonian", code: "mk", icon: "🇲🇰" },
  { name: "Armenian", code: "hy", icon: "🇦🇲" },
